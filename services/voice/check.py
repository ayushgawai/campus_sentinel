...
async def _main() -> None:
    ...
    # Shorten waits for check
    from services.voice import agent as agent_mod

    script = [
        agent_mod.CallScriptStep(0.01, "sentinel", "simulated"),
        agent_mod.CallScriptStep(0.01, "sentinel", tool="lookup_location"),
        agent_mod.CallScriptStep(0.01, "sentinel", tool="get_person_description"),
    ]
