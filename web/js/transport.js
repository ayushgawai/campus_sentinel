...
import { createMockPlayer, atIso, predictedCameraAt } from "./mock.js?v=live2";
import { validateEvent } from "./validate.js?v=live2";
import { setMode, setMockT, sampleServerTime } from "./clock.js?v=live2";
